    ...
    <main className="min-h-screen w-full box-border">
      <div className="max-w-[1220px] w-full mx-auto flex flex-col md:flex-row min-h-screen">
        <aside className="w-full md:w-[30%] md:min-w-[280px] py-6 px-4 md:py-10 md:px-8 flex flex-col justify-center gap-2 text-left font-basteleur shrink-0">
          <Motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0, ease: 'easeOut' }}>
          ...
          <Motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.2, ease: 'easeOut' }}>
          ...
          <Motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.4, ease: 'easeOut' }}>
          ...
          <Motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.5, ease: 'easeOut' }}>
            <a
